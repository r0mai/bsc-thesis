	...
	\begin{tikzpicture}
		...
		\begin{umlpackage}{dn}
			\umlclass[x=0, y=-5, anchor=west]{Action}{
				\umlprivate{}boost::optional<string> outputFilename
			}{
	...
	\begin{tikzpicture}
		...
		\begin{umlpackage}{dn}
			\umlclass[x=0, y=-6, anchor=west]{Consumer}{
				\umlprivate{}clang::CompilerInstance\& ci\\
				\umlprivate{}string inputFile \\
				\umlprivate{}string outputFile \\
				\umlprivate{}map<string, string> debugPrefixMap
			}{
				\umlprivate{}\umlvirt{void HandleTranslationUnit()}
			}
			\umlsimpleclass[x=11, y=-6, anchor=east]{Visitor}
	...
	\begin{tikzpicture}
		...
		\begin{umlpackage}{dn}
			...
			\umlclass[x=13.5, y=-5, anchor=north east]{VariableDeclaration}{
				\umlprivate{}string name \\
				\umlprivate{}string type \\
				\umlprivate{}vector<string> occurences
			}{
			...
			\umlcompo[mult1=1, mult2=*, geometry=|-|, arm2=0]
