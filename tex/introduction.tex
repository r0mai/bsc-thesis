...
A Vim-plugin is also provided to allow users Vim-users to integrate the tools
provided into their daily workflow.
...
The last \fref{chap:Closing} summarizes the work, and what further
