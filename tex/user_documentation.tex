...
\begin{lstlisting}[caption={CMake Invokation without the Plugin}]
mkdir build
cd build
cmake -G "Ninja" ..
\end{lstlisting}
do
\begin{lstlisting}[caption={CMake Invokation with the Plugin}]
mkdir build
cd build
cmake -G "Ninja" \
...
\lstinputlisting[language=json, numbers=left, caption=examples.cpp.o.names.json]
...
\begin{lstlisting}[language=vimscript]
